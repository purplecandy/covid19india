...
class PastCountryDataTiles extends StatelessWidget {
  const PastCountryDataTiles({Key key}) : super(key: key);
...
class HeaderTile<S, T> extends StatelessWidget {
  final bloc;
  final String title;
  final int days;
  const HeaderTile({Key key, this.bloc, this.title, this.days})
      : super(key: key);
